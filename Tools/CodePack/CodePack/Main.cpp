...
void CombineWriteHeader(List<WString>& lines, const Dictionary<FilePath, WString>& reverseCategories, const List<FilePath>& files, LazyList<WString> externalIncludes)
{
	lines.Add(L"/***********************************************************************");
...
void Combine(const Dictionary<FilePath, WString>& reverseCategories, const List<FilePath>& files, FilePath outputFilePath, FilePath outputIncludeFilePath, SortedList<WString>& systemIncludes, LazyList<WString> externalIncludes)
{
	...
	{
		List<WString> lines;
		CombineWriteHeader(lines, reverseCategories, files, externalIncludes);
		{
